...
public class ShopManager : MonoBehaviour
{
    ...
    public void SellItem(int itemId) 
    {
        ...
        {
            var consumableIndex = itemId % 2;
            var shopItem = this.playerInventory.consumables[consumableIndex];
            var teste = this.playerInventory.consumables[consumableIndex];
            this.playerInventory.AddGold(15);
            this.playerInventory.RemoveConsumable(shopItem.item);
            this._shopInventory.AddConsumable(teste.item);
        }
    }
}
